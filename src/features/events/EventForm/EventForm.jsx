...
const validate = combineValidators({
  ...
  // can provide a message or just the name of the field for no custom messaging
...
class EventForm extends Component {
  onFormSubmit = (values) => {
    // moment and the date picker return an object 
    // we need to convert it to a string for it to be usable by React 
        ...
        <Grid.Column width={10}>
          <Segment>
            ...
            <Form onSubmit={this.props.handleSubmit(this.onFormSubmit)}>
              ...
              <Field name='date' type='text' component={DateInput} dateFormat='YYYY-MM-DD HH:mm' timeFormate='HHH:mm' showTimeSelect placeholder='Date and Time of event' />
